...
function sidebar_widgets_init_2() {
...
add_action( 'widgets_init', 'sidebar_widgets_init_2' );
...
'employment_widget',
// widget name
__('Employment Custom Widget', ' employment_widget_domain'),
// widget description
array( 'description' => __( 'Employment Custom Widget', 'employment_widget_domain' ), )
);
}
...
if ( ! empty( $title ) )
	//output
echo __( 'Current state of employment:  ', 'employment_widget_domain' );
...
$title = __( 'Default Title', 'employment_widget_domain' ); 
?>
<p>
<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Current employment:' ); ?></label>
