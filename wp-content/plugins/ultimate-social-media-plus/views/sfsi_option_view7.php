...
<!-- 	    <div class="sfsi_plus_prem_show">
		...
		<div class ="sfsi_plus_new_prmium_follw">
			...
			<p>
				...
				<br>
				<a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=more_popup_options&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
			</p>	        	
		</div>
