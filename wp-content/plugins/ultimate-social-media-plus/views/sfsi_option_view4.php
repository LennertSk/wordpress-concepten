	...
	<div class="sfsiplus_count_sections" style="display:none">
		...
		<div class="sfsiplus_specify_counts sfsiplus_pinterest_section">
			...
			<div class="sfsi_plus_new_prmium_follw">
					<p>
						<b>New: </b>In the Premium Plugin you can also automatically show the number of PINs from your Pinterest account, or of a specific board, or the number of your Pinterest followers. <a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=more_pinterest_counts&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
					</p>
			</div>			    
		</div>
