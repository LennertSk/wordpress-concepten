...
<div class="tab2">
        ...
        <div class="inr_cont">
           ...
           <?php if($option2['sfsi_plus_premium_email_box'] =='yes') { ?>
            <div class ="sfsi_plus_new_prmium_follw">
				<p>	
					<b><?php _e( 'New:', SFSI_PLUS_DOMAIN); ?></b><?php _e( ' In our Premium Plugin you can now give your email icon other functions too, e.g. contact you (email), share by email, and link to a certain page (e.g. your contact form or newsletter sign-up site). ', SFSI_PLUS_DOMAIN); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=more_functions_email_icon&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
				</p>
            </div>
            <?php } ?>
        </div>
    ...
    <div class="row sfsiplus_facebook_section">
        ...
        <div class="inr_cont">
            ...
            <div class="sfsi_plus_new_prmium_follw">
				<p>
					<b><?php  _e( 'New:', SFSI_PLUS_DOMAIN); ?></b>	<?php  _e( ' In our Premium Plugin you can also allow users to follow you on Facebook directly from your site (without leaving your page, increasing followers). ', SFSI_PLUS_DOMAIN); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=direct_follow_facebook&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>					
				</p>
            </div>
            <?php } ?>
    ...
    <div class="row sfsiplus_twitter_section">
        ...
        <div class="inr_cont twt_tab_2">
            ...
            <div class= "sfsi_plus_new_prmium_follw">
				<p>
					<b><?php  _e( 'New: ', SFSI_PLUS_DOMAIN ); ?></b><?php  _e(  "Tweeting becomes really fun in the Premium Plugin – you can insert tags to automatically pull the title of the story & link to the story, attach pictures & snippets to the Tweets ( 'Twitter cards') and user Url-shorteners, all leading to more Tweets and traffic for your site!. ", SFSI_PLUS_DOMAIN ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=better_tweets&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
			    </p>
			</div>
            <?php } ?>
        </div>
...
<!--MZ CODE START-->	 
    ...
    <div class="row sfsiplus_ok_section">
		...
		<div class="inr_cont">
			...
			<div class= "sfsi_plus_new_prmium_follw">
			<p>
				<b><?php  _e( 'New: ', SFSI_PLUS_DOMAIN ); ?></b><?php  _e(  "In our Premium Plugin you can now give OK icon other functions too, e.g. <b>like your website/blog, subscribe/follow you</b> on OK.", SFSI_PLUS_DOMAIN ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=ok_like_and_subscribe&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
		    </p>
		</div>
		</div>
    </div>
    ...
    <div class="row sfsiplus_telegram_section">
		...
		<div class="inr_cont">
			...
			<div class= "sfsi_plus_new_prmium_follw">
			<p>
				<b><?php  _e( 'New: ', SFSI_PLUS_DOMAIN ); ?></b><?php  _e(  " In our Premium Plugin you can now give your Telegram icon sharing functionality too, e.g. share your website/blog with friends. ", SFSI_PLUS_DOMAIN ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=telegram_sharing&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
		    </p>
		</div>
		</div>
		...
		<div class="inr_cont">
			...
			<div class= "sfsi_plus_new_prmium_follw">
				<p>
					...
					<?php  _e(  "In our Premium Plugin you can now give your VK icon sharing functionality too, e.g. <b>share your website/blog</b> with friends.", SFSI_PLUS_DOMAIN ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=vk_share&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
				</p>
			</div>
		</div>
    </div>
    ...
    <div class="row sfsiplus_wechat_section" style="display: <?php echo isset($option1["sfsi_plus_wechat_display"])&&$option1["sfsi_plus_wechat_display"]=="yes"?'block':'none';  ?>">
		...
		<div class="inr_cont">
			...
			<p>
				<b><?php  _e( 'New: ', SFSI_PLUS_DOMAIN ); ?></b>
				<?php  _e(  "In our Premium Plugin you can also allow users to <b>follow you</b> on WeChat.", SFSI_PLUS_DOMAIN ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=wechat_sharing&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
		    </p>
		</div>
		</div>
    ...
    <div class="row sfsiplus_weibo_section">
		...
		<div class="inr_cont">
			...
			<p>
				<b><?php  _e( 'New: ', SFSI_PLUS_DOMAIN ); ?></b>
				<?php  _e(  " In our Premium Plugin you can now give Weibo icon other functions too, e.g. <b>like your website/blog, share your website/blog</b> on Weibo.", SFSI_PLUS_DOMAIN ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=weibo_like_and_share&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
		    </p>
		</div>
		</div>
    ...
    <div class="row sfsiplus_google_section">
        ...
        <div class="inr_cont google_in">
            ...
            <div class ="sfsi_plus_new_prmium_follw" >
				<p>
				   <b><?php  _e( 'New: ', SFSI_PLUS_DOMAIN ); ?></b><?php  _e( 'In our Premium Plugin you can also allow users to follow you on Google+ directly from your site (without leaving your page, increasing followers). ', SFSI_PLUS_DOMAIN ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=direct_follow_google&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
				</p>
            </div>
            <?php } ?>
        </div>
...
when people click on it, they can call you, or send you an SMS). ', SFSI_PLUS_DOMAIN); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=call_or_sms_feature_custom_icons&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
			</p>
    	</div>
