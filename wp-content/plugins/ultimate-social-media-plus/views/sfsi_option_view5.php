...
<!--     	<div class="sfsi_plus_icons_prem_disc">
		...
		<div class="sfsi_plus_new_prmium_follw">
            <p>
				<b><?php  _e( 'New: ', SFSI_PLUS_DOMAIN ); ?></b><?php  _e( 'The Premium Plugin also allows you to define the vertical distance between the icons (and set this differently for mobile vs. desktop): ', SFSI_PLUS_DOMAIN ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=more_spacings&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
			</p>
		</div>
    ...
    <div class="row">
		...
		<div class ="sfsi_plus_new_prmium_follw">
			<p>
				...
				<br>
				<a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=more_alignment_options&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
			</p>
		</div>
		<?php } ?>
    </div>
...
<div class="row sfsi_custom_social_data_setting" id="custom_social_data_setting">
		...
		<div class="sfsi_plus_new_prmium_follw sfsi_social_sharing" style="margin-bottom: 15px;">
			<p><?php _e("Note: This feature is currently only available in the Premium Plugin.",SFSI_PLUS_DOMAIN); ?> <a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=define_pic_and_text&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
			</p>
		</div> 		
</div>
