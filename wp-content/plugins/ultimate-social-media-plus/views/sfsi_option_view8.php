...
<div class="tab8">
	...
	<div class ="sfsi_plus_new_prmium_follw">
		<p>
			<b><?php  _e( 'New: ', SFSI_PLUS_DOMAIN ); ?></b><?php  _e( 'In our Premium Plugin you have many more placement options, e.g. place the icons statically on the page, optimize placement for mobile, don’t show them on certain pages, show them while user is scrolling down the page (or not) etc. ', SFSI_PLUS_DOMAIN ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go prermium now.', SFSI_PLUS_DOMAIN); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=more_placement_options&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more.', SFSI_PLUS_DOMAIN); ?></a>
			</p>
    </div>
    <?php } ?>
